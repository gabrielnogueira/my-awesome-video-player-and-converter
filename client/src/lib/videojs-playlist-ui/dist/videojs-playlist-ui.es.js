...
var PlaylistMenuItem = function (_Component) {
  ...
  PlaylistMenuItem.prototype.createEl = function createEl() {
    ...
    if (item.status) {
      ...
      status.className = 'vjs-playlist-name vjs-playlist-status';
    ...
    if (item.barclass) {
      ...
      bar.className = 'meter vjs-playlist-name vjs-playlist-bar';
...
var PlaylistMenu = function (_Component2) {
  ...
  PlaylistMenu.prototype.createPlaylist_ = function createPlaylist_() {
    var playlist = this.player_ ? this.player_.playlist() || [] : [];
    var list = this.el_ ? this.el_.querySelector('.vjs-playlist-item-list') : null;
    var overlay = this.el_ ? this.el_.querySelector('.vjs-playlist-ad-overlay'): null;
  ...
  PlaylistMenu.prototype.update = function update() {
    ...
    var currentItem = this.player_ ? this.player_.playlist.currentItem() : -1;
